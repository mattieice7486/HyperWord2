...
//each pupster card = the word that the user is guessing
//green thumb = user got correct word
//red thumb = user got it wrong

// let partsOfSpeechArray;
// let abbreviatedPOSArray;
// let POSIndex;
// let abbreviatedRandomPOS;
// let randomPOS;
// let targetScore;
...
class Game extends Component {
    ...
    letterClick = (event) => { //on letter click function
        ...
        //const newState = { ...this.state }; //need this???????????
    };
    ...
    render() {
        return (
          <div>
              ...
              <Row>
              <Keyboard>
                  Should I enter the keys here or in Keyboard.js????
              </Keyboard>
              </Row>
          </div>
        );
